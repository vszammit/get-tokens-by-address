...
4. Open `get_tokens.js` and update the value of the Wallet Address found within the main function on line 13 and to reflect the wallet that you will be querying. 
...
7. Run the script in the terminal: `node get_tokens.js`
